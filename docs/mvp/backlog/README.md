...
| 2     | [AWS-001 — Secure the AWS account and add cost guardrails](01-aws-console.md#aws-001--secure-the-aws-account-and-add-cost-guardrails)        | User  | None                             | pending   |
...
| 4     | [BE-003 — Add the SAM development stack](00-foundation.md#be-003--add-the-sam-development-stack)                                             | Codex | BE-002                           | pending   |
